...
static const char *strMainNetDNSSeed[][2] = {
    {"byte-coin.org", "seed.byte-coin.org"},
    {"bytecoin.cn", "seed.bytecoin.cn"},
    {"baitebi.cn", "seed.baitebi.cn"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"byte-coin.org", "testnet-seed.byte-coin.org"},
    {"bytecoin.cn", "testnet-seed.bytecoin.cn"},
    {"baitebi.cn", "testnet-seed.baitebi.cn"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    0x15fa8677, 0xe8fb8677, 0xe8e05a70
};
