...
uint256 hashGenesisBlock("0x000000009ef37d85812c49423e9fd88d59ec492b63f91c508ff3c30852ff536c");
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uBYC
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // two weeks
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000b026ea28681e9f759a5c6e320bc7a6c178bcefd34c2ebf0ac2bbe48e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Alibaba Hits 35 Bln Yuan on Double 11";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 2;
        block.nTime    = 1386824460;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 1488870105;

        if (fTestNet)
        {
            block.nTime    = 1386663184;
            block.nNonce   = 1360406661;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x33fdb2465b68370b149e8b6d46818ce2496eb9af463c5cc5bdf10b0e1cd1b700"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb8, 0xbe, 0xb4, 0xb9 };
