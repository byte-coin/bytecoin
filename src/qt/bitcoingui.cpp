...
void BitcoinGUI::createActions()
{
    ...
    checkUpdateAction = new QAction(QIcon(":/icons/checkupdate"), tr("&Check For Update"), this);
    checkUpdateAction->setStatusTip(tr("Check update for Bytecoin"));
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Bytecoin"), this);
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addSeparator();
    help->addAction(checkUpdateAction);
    help->addSeparator();
...
void BitcoinGUI::checkUpdateClicked()
{
    QDesktopServices::openUrl(QUrl("http://www.byte-coin.org", QUrl::TolerantMode));
}

void BitcoinGUI::openMinerClicked()
{
...
{
    QString strTitle = tr("Bytecoin"); // default title
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::BYC, nFeeRequired));
